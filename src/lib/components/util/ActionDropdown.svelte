...
<div class="dropdown-container relative inline-block text-left">
	<button
		type="button"
		class="inline-flex items-center justify-center rounded-md border-none p-1 text-sm font-medium text-gray-700 hover:bg-blue-200 focus:bg-blue-200 focus:ring-1 focus:ring-blue-500 focus:outline-none"
