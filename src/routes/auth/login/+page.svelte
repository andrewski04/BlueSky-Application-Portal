...
<svelte:head>
	<title>Login - BlueSky Tennessee Institute</title>
	<style>
		.login-prompt {
...
<div class="nprogressbar flex min-h-screen flex-col items-center justify-center bg-gray-300">
	<div class="login-prompt mx-auto w-full max-w-lg space-y-8 rounded-lg p-12 shadow-lg">
		...
		<div class="space-y-4 text-center">
			...
			<p class="text-lg text-white">We'll send a login link to your email</p>
			...
			<form class="space-y-6" method="POST">
				...
				<div>
					<button type="submit" class="btn-green px-6 py-3"> Login </button>
				</div>
